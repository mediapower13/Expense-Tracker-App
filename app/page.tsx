  ...
  if (error) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="bg-card border border-destructive/50 rounded-xl p-8 max-w-md w-full shadow-xl">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-card-foreground">Failed to Load Data</h3>
              <p className="text-sm text-muted-foreground">We couldn't load your financial data. Please check your connection and try again.</p>
            </div>
